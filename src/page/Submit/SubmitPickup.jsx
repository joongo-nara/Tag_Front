    ...
    <div className="pickup-container">
      ...
      <form className="pickup-form" onSubmit={handleSubmit}>
        ...
        <div className="form-row">
          <label className="form-label">배송방법 <span className="required">*</span></label>
          <div className="input-group">
            <input type="text" value="수거" disabled readOnly className="input-box disabled" />
          </div>
        </div>

        {/* 무게 (안내문구 추가) */}
        <div className="form-row">
          <label className="form-label">무게(kg) <span className="required">*</span></label>
          <div className="input-group">
            <input 
              type="number" 
        ...
        <div className="form-row">
          ...
          <div className="input-group-vertical">
            ...
            <div className="address-search-row">
              ...
              />
              <button type="button" className="search-btn" onClick={handleAddressSearch}>주소 검색</button>
            </div>
            {/* 상세 주소 */}
            <input 
              type="text" 
        ...
        <div className="form-row">
          ...
          <div className="input-group">
            <input type="text" value="상품 수거는 무료입니다." disabled readOnly className="input-box disabled" />
          </div>
        </div>

        {/* 사진등록 */}
        <div className="form-row">
          <label className="form-label">사진등록 <span className="required">*</span></label>
          <div className="input-group">
            <div className="photo-area">
              ...
              {images.map((img, index) => (
                <div key={index} className="preview-box">
                  ...
                  <button type="button" className="delete-img-btn" onClick={() => removeImage(index)}>
                    <IoClos eCircle />
                  </button>
                </div>
              ))}
        ...
        <div className="button-area">
          <button type="submit" className="submit-btn">접수하기</button>
        </div>
